public class Professores {
    ...
    public Professores(String nome, double salario, int idade) {
        this.nome = nome;
    ...
    private void pagamentoMensal() {
        this.pagamento = (this.pagamento + 1100.00);
    }
    ...
    public void Metas() {
        System.out.println("Os Professores receberam a bonificação referente as metas.");
    }
